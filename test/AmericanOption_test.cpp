...
TEST_F(OptionTest, TestAmericanOptionConstruction) {
    AmericanOption callOption(callPayoff, T, sigma, r, r);
...
TEST_F(OptionTest, TestAmericanOptionCopyConstruction) {
    AmericanOption original(callPayoff, T, sigma, r, r);
